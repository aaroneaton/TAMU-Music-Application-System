...
CREATE TABLE user_meta (
    ...
    phone varchar(20),
  PRIMARY KEY(id),
  CONSTRAINT user_meta_check_id CHECK(id >= 0),
  CONSTRAINT user_meta_check_user_id CHECK(user_id >= 0)
);
...
SET IDENTITY_INSERT user_meta ON;
INSERT INTO user_meta (id, user_id, first_name, last_name, company, phone) VALUES ('1','1','Admin','istrator','ADMIN','0');
SET IDENTITY_INSERT user_meta OFF;
